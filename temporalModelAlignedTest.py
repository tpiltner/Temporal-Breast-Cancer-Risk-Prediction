...
DEFAULT_EXP_ROOT = Path("/local/scratch/tpiltne/models/temporalModelAligned")
...
def collect_logits_labels_masks(
    ...
    """
    Expected batch:
      (imgs, delta_feat, has_prior_views, y, m) [+ optional group_id]
    """
    model.eval()
...
def main():
    ...
    eval_dir = exp_dir / f"eval_temporal_aligned{run_tag}"
    ...
    val_ds = Temporal1AlignedDataset(split="val")
    test_ds = Temporal1AlignedDataset(split="test")
